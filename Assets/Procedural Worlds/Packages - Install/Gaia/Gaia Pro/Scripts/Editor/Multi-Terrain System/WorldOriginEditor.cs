...
namespace Gaia
{
    ...
    class WorldOriginEditor
    {
        ...
        public static void RenderSceneGUI(SceneView sceneview)
        {
            ...
            if (!TerrainLoaderManager.Instance.m_showGoToTerrainButton || TerrainLoaderManager.Instance.TerrainSceneStorage == null || TerrainLoaderManager.Instance.TerrainSceneStorage.m_terrainScenes.Count <= 0)
            {
                Handles.EndGUI();
                return;
            }
        ...
        private static void DrawGizmos()
        {
            ...
            if (TerrainLoaderManager.Instance.m_showOriginTerrainBoxes)
            {
                ...
                {
                    if ((terrainScene.m_regularLoadState == LoadState.Loaded || terrainScene.m_impostorLoadState == LoadState.Loaded) && TerrainLoaderManager.Instance.m_showOriginTerrainBoxesLoaded)
                    {
                    ...
                    if (terrainScene.m_regularLoadState != LoadState.Loaded && terrainScene.m_impostorLoadState != LoadState.Loaded && TerrainLoaderManager.Instance.m_showOriginTerrainBoxesUnLoaded)
                    {
