...
// SDF object declarations
    float4 obj0 = float4 (GetCubeSdf(zRepeatModifier(xRepeatModifier(RM_TRANS(p,SdfInstances[0].modelData),spacingx0,scrollx0),spacingz0,scrollz0),SdfInstances[0].modelData[3].x,cubeRoundness0,cubeSize0),0,0);
// SDF modifier groups
