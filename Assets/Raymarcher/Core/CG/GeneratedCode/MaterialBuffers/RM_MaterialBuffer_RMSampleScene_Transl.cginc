...
half4 RM_PerObjRenderMaterials(in Ray ray, half4 sdfRGBA, in int sdfMaterialType, in int sdfMaterialInstance)
{
    ...
    sdfRGBA = sdfMaterialType != 0 ? sdfRGBA : CalculatePBRModel(RMStandardPBRDataInstance[sdfMaterialInstance], ray, sdfRef);
...
{
    half4 sdfRef = sdfRGBA;
    sdfRGBA = sdfMaterialType != 0 ? sdfRGBA : CalculateReflections(RMStandardPBRDataInstance[sdfMaterialInstance], ray, sdfRef);
