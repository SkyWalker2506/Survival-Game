...
namespace HQFPSTemplate.Equipment
{
	...
	public class LauncherWeapon : ProjectileWeapon
	{
		...
		public LauncherInfo.LaunchingInfo LaunchingInfo => m_L;
		...
		private IEnumerator C_LaunchWithDelay(Ray[] itemUseRays) 
		{
			...
			projectileObject.GetComponent<Rigidbody>().linearVelocity = projectileObject.transform.forward * m_L.LaunchSpeed;
