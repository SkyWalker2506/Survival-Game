...
namespace HQFPSTemplate.Equipment
{
	public partial class ThrowingWeapon : EquipmentItem
	{
		...
		public ThrowingWeaponInfo ThrowingWeaponInfo => m_TW;
		...
		private IEnumerator C_ThrowWithDelay(int throwIndex)
		{
			...
			projectileRB.linearVelocity = (projectile.transform.forward * m_TW.Throwing.ThrowVelocity) + Player.Velocity.Get();
