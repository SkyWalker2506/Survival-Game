...
{
    public class HQAddEquipmentWindow : EditorWindow
    {
        private CustomEquipmentInstance m_EquipmentInstance;
        ...
        private bool m_ShowGeneralInfo = true;
        private bool m_DrawPrefabsInfo = true;
        ...
        {
            var window = GetWindow<HQAddEquipmentWindow>(true, "Add Equipment");
        ...
        {
            var equipmentItems = Resources.LoadAll<CustomEquipmentInstance>("");
        ...
        private void OnGUI()
        {
            if (m_EquipmentInstance != null)
            {
                ...
                EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                m_ShowGeneralInfo = EditorGUILayout.Foldout(m_ShowGeneralInfo, "General Info", EditorGUICustom.FoldOutStyle);
                if (m_ShowGeneralInfo) DrawGeneralInfo();
                EditorGUILayout.EndVertical();

                //Draw Prefabs Info Foldout
                EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                m_DrawPrefabsInfo = EditorGUILayout.Foldout(m_DrawPrefabsInfo, "Prefabs", EditorGUICustom.FoldOutStyle);
                if (m_DrawPrefabsInfo) DrawPrefabsInfo();
                EditorGUILayout.EndVertical();
