...
{
	[CreateAssetMenu(fileName = "Camera Physics Profile", menuName = "HQ FPS Template/Player/Camera Physics Profile")]
	public class CameraPhysicsProfile : ScriptableObject
    {
		#region Internal
